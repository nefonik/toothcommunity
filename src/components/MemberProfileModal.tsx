  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div
        ...
        className="w-full max-w-sm bg-[#2b2d31] border border-[#202225] rounded-[12px] shadow-2xl overflow-hidden text-[#dbdee1] flex flex-col"
      >
        {/* Banner Top */}
        <div
          className="h-20 w-full relative"
          style={{
            backgroundColor: member.avatarColor || "#5865f2",
            opacity: 0.85,
          }}
        >
          <button
            onClick={onClose}
            className="absolute top-2 right-2 bg-black/40 hover:bg-black/70 text-white rounded-full p-1 transition-colors"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="px-5 pb-5 pt-0 relative">
            ...
            {!isMe && (
              <div className="flex items-center gap-2 mb-2">
                <button
                  ...
                  className="p-2 bg-[#1e1f22] hover:bg-[#5865f2] text-[#dbdee1] hover:text-white rounded-[6px] transition-all cursor-pointer shadow"
                >
          ...
          {(canModerateAsSupport || canModerateAsAdmin) && (
            <div className="mt-4 pt-3 border-t border-[#35373c] space-y-3">
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 py-1.5 px-3 rounded-[4px] text-xs font-semibold transition-colors cursor-pointer ${
                  isMuted
